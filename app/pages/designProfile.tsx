...
export function Design(){
    ...
    return(
        <div className="">
            ...
            <div className="hidden md:grid grid-rows-[60px_1fr] grid-cols-1 bg-[#1E3A8A] h-screen border-4">
                ...
                <div className="grid grid-rows-[60px_1fr] bg-[#F9FAFB] rounded-tl-2xl rounded-tr-2xl">
                    ...
                    <div className="grid grid-cols-[auto_1fr_310px]">
                        <div className="border-2 flex flex-col pl-7 pt-6 pr-3 gap-2 text-[#848484]">
                            <Button variant="ghost" className="text-[20px]" onClick={()=>handleOpen("Profil")}>
                                <FontAwesomeIcon icon={faCircleUser}/>
                                <span className="hidden">Profil</span> 
                            </Button>
                            <Button variant="ghost" className="text-[20px]" onClick={()=>handleOpen("Thème")}>
                                <FontAwesomeIcon icon={faSliders} />
                                <span className="hidden">Thème</span> 
                            </Button>
                            <Button variant="ghost" className="text-[20px]" onClick={()=>handleOpen("Fond")}>
                                <FontAwesomeIcon icon={faLayerGroup} />
                                <span className="hidden">Fond</span> 
                            </Button>
                            <Button variant="ghost" className="text-[20px]" onClick={()=>handleOpen("Style")}>
                                <FontAwesomeIcon icon={faPaintRoller} />
