    ...
    return(
        <div className="max-w-11/12 w-11/12 mx-auto my-3.5 py-10 flex flex-col gap-[3vw] lg:gap-[2.5vw]">
            ...
            <div className="flex flex-col gap-[2vw] lg:gap-[1vw] lg:w-[65%] lg:m-auto">
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Qu’est-ce que FastProfile ?</AccordionTrigger>
                ...
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Est-ce gratuit ?</AccordionTrigger>
                        <AccordionContent className="md:text-[1.5vw] lg:text-[1.4vw]">
                ...
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Ai-je besoin de compétences techniques pour l’utiliser ?</AccordionTrigger>
                        <AccordionContent className="md:text-[1.5vw] lg:text-[1.4vw]">
                ...
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Est-ce que je peux personnaliser l’apparence de ma page ?</AccordionTrigger>
                        <AccordionContent className="md:text-[1.5vw] lg:text-[1.4vw]">
                ...
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Est-ce que mon profil est accessible sur mobile ?</AccordionTrigger>
                        <AccordionContent className="md:text-[1.5vw] lg:text-[1.4vw]">
                ...
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Puis-je mettre à jour mes liens facilement ?</AccordionTrigger>
                        <AccordionContent className="md:text-[1.5vw] lg:text-[1.4vw]">
                ...
                <Accordion type="single" collapsible className="bg-[#112F81] rounded-2xl border-2 border-solid border-[#112F81] hover:border-[#6486E3] hover:transition-all hover:border-2 hover:border-solid">
                    <AccordionItem value="item-1" className="p-3 rounded-2xl">
                        <AccordionTrigger className="[&>svg]:text-[#F0F0F0] md:text-[2vw] lg:text-[1.5vw] hover:no-underline">Est-ce sécurisé ?</AccordionTrigger>
                        <AccordionContent className="md:text-[1.5vw] lg:text-[1.4vw]">
